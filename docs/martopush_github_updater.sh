# =====================================================
# ✅ MARTOPUSH v5.76 — AWTO ITABI MUNA BAGO MAG-PULL!
# ✅ WALANG ERROR NA "cannot pull with rebase" — AWTO SOLUSYON!
# ✅ AUTO-RESUME KAPAG BALIK ANG INTERNET!
# ✅ BAGO MAG-COMMIT → ILILISTA MUNA + PAPIPILIIN KA!
# ✅ HINDI LAHAT ANG IPAPADALA — IKAW ANG PIPILI ALIN LANG!
# =====================================================
...
#!/bin/bash
# ==========================================
# 🎸 M A R T O P U S H  —  v5.76
# ✅ AWTO ITABI MUNA BAGO MAG-PULL — WALANG "cannot pull with rebase" ERROR!
# ✅ AUTO-RESUME: NAWALA ANG INTERNET? → HINTAY + ULIT HANGGANG MATAGUMPAY!
# ✅ BAGO MAG-COMMIT → ILILISTA MUNA + PAPIPILIIN KA!
# ✅ HINDI LAHAT ANG IPAPADALA — IKAW ANG PIPILI ALIN LANG!
# ==========================================
...
AWTO_PULL_BAGO_PUSH() {
  ...
  # ✅ AWTO ITABI — WALANG TANONG!
  AWTO_ITABI_PAGBABAGO

  git pull origin main --rebase 2>&1
  local KODI=$?

  # ✅ IBALIK AGAD ANG PAGBABAGO
  AWTO_BALIK_PAGBABAGO
...
while true; do
  ...
  case "$PILI_MENU" in
    ...
    1)
      ...
      TMP=$(mktemp)
      cat > "$TMP"
      [ ! -s "$TMP" ] && { echo -e "${Y}ℹ️ Walang ipinaste${N}"; rm -f "$TMP"; sleep 1; continue; }
...
echo "╠══════════════════════════════════════════════════════════════╣"
echo "║   🎸 MARTOPUSH v5.76 — AWTO ITABI BAGO MAG-PULL!              ║"
echo "║   ✅ WALANG ERROR NA 'cannot pull with rebase' — AYUS NA!      ║"
echo "║   ✅ AUTO-RESUME KAPAG BALIK ANG INTERNET                      ║"
echo "║   ✅ HINDI KA NA TATANUNGIN — AWTO NA ANG GAGAWIN!             ║"
echo "╚══════════════════════════════════════════════════════════════╝"
echo ""
echo "👉 I-type: martopush"
echo ""
